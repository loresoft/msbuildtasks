...
namespace MSBuild.Community.Tasks.Properties {
    ...
    internal class Resources {
        ...
        internal static string DeleteTreeExceededRetries {
            get {
                return ResourceManager.GetString("DeleteTreeExceededRetries", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to One or more of the directory-paths specified is null or full of whitespaces..
        /// </summary>
        internal static string DeleteTreeInvalidDirectoriesPaths {
            get {
                return ResourceManager.GetString("DeleteTreeInvalidDirectoriesPaths", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} is an invalid retry count. Value must not be negative..
        /// </summary>
        internal static string DeleteTreeInvalidRetryCount {
            get {
                return ResourceManager.GetString("DeleteTreeInvalidRetryCount", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} is an invalid retry delay. Value must not be negative..
        /// </summary>
        internal static string DeleteTreeInvalidRetryDelay {
            get {
                return ResourceManager.GetString("DeleteTreeInvalidRetryDelay", resourceCulture);
            }
        }
        ...
        internal static string DeleteTreeRetrying {
            get {
                return ResourceManager.GetString("DeleteTreeRetrying", resourceCulture);
            }
        }
