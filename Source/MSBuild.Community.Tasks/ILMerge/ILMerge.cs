	...
	public class ILMerge : ToolTask
	{
		...
		protected override string GenerateFullPathToTool()
		{
			return Path.Combine(
				...
				@"Microsoft\ILMerge\" + this.ToolName);
		}
		...
		protected override string GenerateCommandLineCommands()
		{
			...
			{
				builder.AppendSwitch(@"/internalize" + ((this.ExcludeFile.ItemSpec.Length == 0)
					? string.Empty
					: @":" + this.ExcludeFile.ItemSpec));
			}
			...
			{
				builder.AppendSwitch(@"/log" + ((this.LogFile.ItemSpec.Length == 0)
					? string.Empty
					: @":" + this.LogFile.ItemSpec));
			}
			...
			if (this.TargetPlatformVersion != null)
			{
				builder.AppendSwitch(@"/targetplatform:"
					...
					+ ((this.TargetPlatformDirectory == null)
						? string.Empty
						: @"," + this.TargetPlatformDirectory.ItemSpec));
			}
